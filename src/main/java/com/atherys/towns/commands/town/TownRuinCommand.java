...
public class TownRuinCommand extends TownsSimpleCommand {
    ...
    protected CommandResult execute(Player player, CommandContext args, Resident resident,
        ...
        if (resident.getTownRank().equals(TownRanks.MAYOR) || player
            .hasPermission("atherystowns.admin.ruin_any")) {
    ...
    public CommandSpec getSpec() {
        return CommandSpec.builder()
            .description(Text.of(
                "Used to ruin a town. This will remove the town from the game, unclaim all it's plots and leave all residents homeless."))
